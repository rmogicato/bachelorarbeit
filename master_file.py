...
"""
# setting file
testing_file = "_DEPRECATED/extractions/new_testing_AFFACT1.txt"
# arcface ids:
...
df_accuracy_og.to_csv("error_rates/AFFACT-A_og.csv")
df_accuracy_af.to_csv("error_rates/AFFACT-A_AF_square_sign_balanced.csv")
df_accuracy_gt.to_csv("error_rates/AFFACT-A_GT_square_sign_balanced.csv")
